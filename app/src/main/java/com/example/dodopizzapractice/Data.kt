...
class DataSource {
    ...
    var listOfIngredients: (Map<Int, Int>) -> (List<Food>) = {
        val list = mutableListOf<Food>()

        for ((categoryI, count) in it) {
            if (categoryI==4){
                pizzaList().subList(0,count+1)
            }else if (categoryI==1) {
    ...
    fun getList(): List<Food> {
        ...
        when (category) {
            ...
            4 -> listOfFood = beveragesList()
            0 -> listOfFood = pizzaList()
            3 -> listOfFood = desertsList()
